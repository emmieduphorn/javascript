$(document).ready(function() { //För att läsa in innehållet på sidan.
  ...
  var url = "http://emmieduphorn.se/javascript18/index.php/wp-json/wp/v2/pages/?_embed=true";
  $.ajax({ //Här kommer ett stycke ajax-kod.
    ...
    timeout: 5000, // //Timeout startar när ajax-förfrågan skickas, tiden anges i millisekunder.
    ...
    error: function(err) { // En funktion som körs om förfrågan misslyckas.
      console.log('Something went wrong...', err); //Om förfrågan misslyckas syns ett felmeddelande.
    }
  });
